---
description: When making changes to this project, working with Astro, or when understanding the project functionanilty as a whole.
globs: 
alwaysApply: false
---
## Overview
...
This template includes automatic sitemap generation using <a href="https://docs.astro.build/en/guides/integrations-guide/sitemap/">`@astrojs/sitemap`</a>. The sitemap helps search_files engines better crawl and index your site.
